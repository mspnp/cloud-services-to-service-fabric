namespace Tailspin.Web.Survey.Shared.Stores
{
    ...
    public class SurveyStore : ISurveyStore
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            await this.surveyTableExtension.EnsureExistsAsync();
        }
        ...
        public async Task<IModelExtension> GetSurveyExtensionByTenantAndSlugNameAsync(string tenant, string slugName, Type extensionType)
        {
            return await this.surveyTableExtension.GetExtensionByPartitionRowKeyAsync(extensionType, tenant, slugName);
        }

        public async Task DeleteSurveyExtensionByTenantAndSlugNameAsync(string tenant, string slugName)
        {
            ...
            await this.surveyTableExtension.DeleteAsync(entity);
        }

        public async Task<IEnumerable<IModelExtension>> GetSurveyExtensionsByTenantAsync(string tenant, Type extensionType)
        {
            var extensions = await this.surveyTableExtension.GetExtensionsByPartitionKeyAsync(extensionType, tenant);

            return extensions.Select(e => e as IModelExtension);
        }
