...
{
    [EventSource(Name = "MyCompany-Tailspin.SurveyManagementService.Application-SurveyManagementService")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(ServiceRequestFailedEventId, Level = EventLevel.Error, Message = "Service request failed", Keywords = Keywords.Requests)]
        public void ServiceRequestFailed(string exception)
        {
